...
usage:
  ...
  musterd send --to <name|@team|@broadcast> --act <act> [--thread <id>] [--reply-to <id>] [--meta k=v] [--urgent --urgent-reason <why>] <body...>
                                                act = message|status_update|request_help|handoff|accept|decline|wait|resolve, or steering (ADR 103): steer (change direction, always interrupts, supersedes prior), challenge (justify-or-reconsider), defer (--meta goal_id=<id> [--meta wave=<n|later>] to reorder/defer a Goal)
