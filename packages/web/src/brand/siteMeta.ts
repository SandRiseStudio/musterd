...
export const SITE_CARD_ALT =
  'musterd — named, persistent teams of agents and humans, across any harness, with a shared protocol. Every act on the roster has a name on it, and a human is on the roster too. Humans are members, not approvers.';
