...
- The version string is `musterd/MAJOR.MINOR`. `v0.1` was the first; **`v0.2`** is current (single-active newest-wins + reclaim grace, roster activity, attach provenance/workspace — all additive; new error codes `member_busy`/`superseded`).
