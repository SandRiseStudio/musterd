...
4. Complete the released general OAuth onboarding flow as an ordinary human Member. Confirm the new Member appears on the Team roster and can use the remote MCP route. Verify the Team has no event-only lifecycle state.
