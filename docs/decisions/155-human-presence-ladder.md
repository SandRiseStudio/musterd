...
- Status: accepted — 2026-07-21; Inc 3 decay amended 2026-08-24 by ADR 316 (applies to agents too, claim kept aged, token `active`). The founder approved the three open decisions as proposed (derived
