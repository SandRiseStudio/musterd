...
- No protocol/server change; this is CLI-only. The `team_join` result copy and the `harness-hooks.md` hooks remain complementary belts, not the primary mechanism.
