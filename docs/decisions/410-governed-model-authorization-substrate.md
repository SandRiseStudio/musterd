# 410 — governed model authorization substrate
...
enrolled `msnode_` credential and the launch credential. The server resolves the Member and node from
stored bindings, cross-checks any caller assertions, and refuses mismatches.
