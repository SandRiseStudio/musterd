...
src/
  ...
  store/
    ...
    governed.ts       // server-owned governed model policy + one-shot launch authorization; node, Presence, context, and Aperture decision checks (ADR 410)
