...
src/
  ...
  commands/
    ...
    seed.ts           // shared Seed tray/read/claim/clarification/brief/conclude/promote Surface (ADR 314)
...
The human Shared Seed Surface (ADR 314). `list` shows the active tray — `open`, `exploring`,
