...
## The repo-root MCP leak (2026-07-13, ADR 143/#268; falsify: claude mcp get musterd per worktree) <!-- claim: defect -->
...
## The binding clobber (2026-07-09; falsify: diff sibling bindings after musterd agent) <!-- claim: defect -->
