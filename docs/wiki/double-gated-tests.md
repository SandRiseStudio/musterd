...
## A second instance, with no gate at all (2026-09-14; falsify: delete the `drift.push` for the manifest line in `packages/cli/src/onboard/doctor.ts` and run `packages/cli/src/onboard/doctor.test.ts`) <!-- claim: defect -->
