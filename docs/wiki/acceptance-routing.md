...
The seat concerned read this section before it landed and did not dispute it; its own account of why the message went unread is not recorded here, and if it offers one this section should carry it.
