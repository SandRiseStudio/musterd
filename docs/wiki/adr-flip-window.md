...
Scanned every commit in `docs/decisions` history for a file whose **own** Status went proposed→accepted in that commit, cross-file false positives excluded (2026-08-31, main @ `4f411b49`; falsify: re-run the scan — partition each flip commit's own-file Decision section before/after): <!-- claim: other -->
