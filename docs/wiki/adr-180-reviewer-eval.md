...
| #1164 | 3 | 0 | 0 | 3 | `cd2815ad` (import order, unrelated) | claims (2026-09-02; falsify: read the cited lines) `rotateAgentKey` re-mints after cutover — it throws `conflict` (`teams.ts:145`); claims `retiredLegacy` is set and never used — used at `http.ts:2966`; a COALESCE "race" | <!-- claim: defect -->
