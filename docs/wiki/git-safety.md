...
## `git checkout <file>` is not an undo (2026-08-05; falsify: try it on a file with two edits) <!-- claim: other -->
...
## `git reset --hard` is not how you check upstream (2026-07-28; falsify: reflog after a reset over unstaged files) <!-- claim: other -->
