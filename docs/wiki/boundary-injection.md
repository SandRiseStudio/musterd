...
## Instance 1 — the marker that could never fire (2026-08-26, #1076; falsify: `git show 4381c4d5` — if `waitingTruncated` was reachable with `limit=100`, the server line `truncated = limit === undefined && full` did not say what this claims)
