...
## The incident (2026-06-29; falsify: send a single-quoted test body containing a backtick command) <!-- claim: other -->
...
## The same class bites `gh pr create` (2026-08-12; falsify: `--body` a double-quoted string containing a backticked command) <!-- claim: other -->
