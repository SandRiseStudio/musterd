...
dashboard streams every act on a team — the firehose — as a legible feed plus an ambient constellation
of who's talking to whom. Success: a glance tells you the team's state; a `resolve` landing feels good;
you trust it enough to leave it running.

## Brand Personality

Precise, calm, alive. The voice is plain and declarative (never hype); the *experience* carries the
...
- Chat-app skins: bubble-and-avatar messenger UI. This is a *stream*, not a chat.
...
5. **Honest motion.** Acts arrive whole and atomic — animate *arrival* and *relationship*, never fake
